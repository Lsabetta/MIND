...
class ResNet(nn.Module):
    def __init__(
        ...
        self.fc = GatedLinear(512 * block.expansion, num_classes, bias=False)
...
def gresnet18(*, weights: Optional[ResNet18_Weights] = None, progress: bool = True, **kwargs: Any) -> ResNet:
